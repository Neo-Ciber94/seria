...
describe("Encode value", () => {
  ...
  test("Encode array", async () => {
    ...
    const value = await encode(array);
...
describe("Encode buffers", () => {
  test("Encode ArrayBuffer", async () => {
    ...
    const value = await encode(buffer);
